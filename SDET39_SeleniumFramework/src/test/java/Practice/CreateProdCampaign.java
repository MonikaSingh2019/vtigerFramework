...
public class CreateProdCampaign {
		 ...
		 FileInputStream fis1=new FileInputStream("./Data/Organize.xlsx"); 
			...
			driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
			 WebElement element = driver.findElement(By.xpath("//a[text()='More']"));
				...
				driver.findElement(By.name("campaignname")).sendKeys(campaignName);//camapaign name
				driver.findElement(By.xpath("//img[@title='Select']")).click();//+icon
				Thread.sleep(3000);
